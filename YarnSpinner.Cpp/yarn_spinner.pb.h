...
public:
  ...
  explicit PROTOBUF_CONSTEXPR Node_LabelsEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void Node::set_sourcetextstringid(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.sourcetextstringid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Node::set_allocated_sourcetextstringid(std::string* sourcetextstringid) {
  ...
  _impl_.sourcetextstringid_.SetAllocated(sourcetextstringid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.sourcetextstringid_.IsDefault()) {
...
inline ::Yarn::Instruction_OpCode Instruction::_internal_opcode() const {
  return static_cast< ::Yarn::Instruction_OpCode >(_impl_.opcode_);
}
